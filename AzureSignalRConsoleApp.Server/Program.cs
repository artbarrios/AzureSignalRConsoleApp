...
namespace AzureSignalRConsoleApp.Server
{
    class Program
    {
        ...
        private static readonly string hubName = "ChatHub";
        private static readonly string serverName = "ChatHub";
        ...
        private static async void Broadcast(string message)
        {
            ...
            var url = $"{serviceUtils.Endpoint}:5002/api/v1-preview/hub/{hubName}";
            ...
            var messageContent = new MessageContent() { Target = "Send", Arguments = new[] { serverName, message } };
